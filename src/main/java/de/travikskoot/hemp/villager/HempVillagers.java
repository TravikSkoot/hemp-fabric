...
public class HempVillagers {
    ...
    public static final VillagerProfession HEMP_FARMER = registerProfession("hemp_farmer",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(Hemp.MOD_ID, "hemp_poi")));

    public static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(Hemp.MOD_ID, name),
